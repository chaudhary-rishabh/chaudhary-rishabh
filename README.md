...
Full-stack engineer with 3+ years specializing in two things: **production AI systems** and **scalable full-stack applications**.

On the AI side, I build **agentic pipelines**, optimize **RAG architectures** for latency and retrieval accuracy, and integrate LLMs into real products — not just wrappers, but systems designed around compute cost, token efficiency, and response time. I specialize in **AI application builders** — platforms like Replit or Lovable where users create and deploy software through AI interfaces.
...
|---------|-------------|-------|
| [**realtime-ai-chat-client**](https://github.com/chaudhary-rishabh/realtime-ai-chat-client) | ChatGPT-alternative at [flexai.chat](https://flexai.chat) — LLM-integrated chat with advanced UX, streaming responses via SSE, and multi-model support | Next.js, TypeScript, SSE |
| [**realtime-ai-chat-server**](https://github.com/chaudhary-rishabh/realtime-ai-chat-server) | Backend powering [flexai.chat](https://flexai.chat) — optimized LLM request routing, streaming SSE responses, token-efficient context management | Node.js, SSE, LLM APIs |
...
[risb.dev](https://risb.dev) · [LinkedIn](https://linkedin.com/in/rishabh029) · [@rishabhcdotin](https://x.com/rishabhcdotin)
